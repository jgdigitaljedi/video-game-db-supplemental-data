...
- Sega Dreamcast games with widescreen mode
...
- Sony PlayStation games that run at 60 FPS
...
There are 918 data points for platforms/consoles.
 Out of 19947 games data points collected so far, the APIs are missing data the following number of games:
