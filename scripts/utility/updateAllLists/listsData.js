...
module.exports.listData = [
  ...
  },
  {
    ...
    special: [
      ...
      require(path.resolve(smallFiles, 'special/n64GamesThatRunAt60Fps.json')),
      require(path.resolve(smallFiles, 'special/n64GamesWithWidescreen.json'))
    ],
  ...
  },
  {
    ...
    special: [
      require(path.resolve(smallFiles, 'special/switchGamesEnhancedOnSwitch2.json')),
  ...
  },
  {
    ...
    special: [
      ...
      require(path.resolve(smallFiles, 'special/masterSystemGamesWithFmAudio.json'))
    ],
  ...
  },
  {
    ...
    special: [
      ...
      require(path.resolve(smallFiles, 'special/dreamcastGamesWithVmuFeatures.json')),
      require(path.resolve(smallFiles, 'special/dreamcastGamesWithWidescreen.json'))
    ],
  ...
  },
  {
    ...
    special: [
      ...
      require(path.resolve(smallFiles, 'special/xboxGamesWithNonRoamableSaves.json'))
    ],
